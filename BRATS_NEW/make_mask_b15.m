...
Nb_healthy = 500;
downsamplerate = 20;
results_path_root ='/home/local/USHERBROOKE/havm2701/data/RESULTS/within_brain_classification/BRATS_2013_LEADERBOARD_MASK2/';
...
%results_path_root = '/Users/uoft/Dropbox/PhD/BratsAnalysis/CHALLENGE2013_KNN_mha/';
 type = 'MAXIME';
 name='000';
Brain_path = ['/home/local/USHERBROOKE/havm2701/data/Data/Maxime_3modality_dataset/data2','/',type,'/',name];
...
new_result_path_brain = [new_results_path_root,type,'/', name];
if exist(new_result_path_brain,'dir')==0
    mkdir(new_result_path_brain)
end

%% load modalities
[T1C, T2, T1,info] = load_modalities_maxime(Brain_path);
...
MASK = uint16(MASK);
mha_MASK_path = [new_result_path_brain,'/','MASK_',type,'_',name,'.mha'];
