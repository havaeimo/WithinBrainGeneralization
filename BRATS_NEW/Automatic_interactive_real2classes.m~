...
if compute_statistics ==0
    main_result_dir = ['/home/local/USHERBROOKE/havm2701/data/RESULTS/within_brain_classification/BRATS_2013_orange2013_res',filesep,user_idx,filesep,'challenge_results',filesep,'',result_sub_directory,'',filesep,'',classifier_name,'_alpha_',num2str(alpha),'_beta_',num2str(beta),'',filesep,''];
elseif compute_statistics==1
    main_result_dir = ['/home/local/USHERBROOKE/havm2701/data/RESULTS/within_brain_classification/BRATS_2013_CHALLENGE',filesep,'journal_2014_linearSVM',filesep,'training_results',filesep,'',result_sub_directory,'',filesep,'',classifier_name,'_alpha_',num2str(alpha),'_beta_',num2str(beta),'',filesep,''];
end
...
if exist(boykov_denoised_result_save_dir,'dir')==0
    ...
    brain_dir = ['/home/local/USHERBROOKE/havm2701/data/Data/BRATS/BRATS2013/brats15_test2/'];
    mask_dir =  ['/home/local/USHERBROOKE/havm2701/data/RESULTS/within_brain_classification/BRATS_2013_challengeday_2class_2013_MASKS/stil_edit_2013/']
...
mask_list = mask_type_list;
     for brain_counter =1:1%length(mask_list)
...
%% Detect the borders of the brain  2013
